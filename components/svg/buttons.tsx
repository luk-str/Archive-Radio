...
export const PreviousTrackButtonSVG = ({ css }: Props) => {
  return (
    <svg
...
export const NextTrackButtonSVG = ({ css }: Props) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
...
export const PlayButtonSVG = ({ css }: Props) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
...
export const PauseButtonSVG = ({ css }: Props) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
